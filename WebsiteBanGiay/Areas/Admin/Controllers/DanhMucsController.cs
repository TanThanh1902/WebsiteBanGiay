...
namespace WebsiteBanGiay.Areas.Admin.Controllers
{
    public class DanhMucsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaDanhMuc,TenDanhMuc,HinhAnhDanhMuc")] DanhMuc danhMuc)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaDanhMuc,TenDanhMuc,HinhAnhDanhMuc")] DanhMuc danhMuc)
        {
            if (ModelState.IsValid)
            {
